  ...
  <el-container class="accounts-container">
    ...
    <el-main class="accounts-main">
      <div class="header">
        ...
        <el-button
          ...
          @click.native="addAccountBoxCtrl('add')"
        >新增</el-button>
      </div>
      <el-table
        v-loading="isLoading"
        ...
        <el-table-column width="220" label="操作" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              @click="addAccountBoxCtrl('edit', scope.row)"
            >编辑</el-button>
            <el-button
              size="mini"
              type="primary"
            ...
            <el-button
              ...
              type="primary"
              class="account-table-btn"
              :disabled="!(pagePermission.disable)"
              @click="accountOperate(scope.row)"
            >禁用</el-button>
            <!-- status === 0 被禁用用户 -->
            <el-button
              v-else
              ...
              type="primary"
              class="account-table-btn"
              :disabled="!(pagePermission.enable)"
              @click="accountOperate(scope.row)"
            >启用</el-button>
          </template>
        </el-table-column>
    ...
    <el-footer>
      <div class="footer-operatete-wrap">
        <el-checkbox
          v-model="allCheckdeValue"
          border=""
          size="mini"
          @change.native="tableToggleSelection"
        >全选</el-checkbox>
...
export default {
  ...
  methods: {
    ...
    batchSelected() {
      switch (this.batchOperateValue) {
        case "changePassword":
          ...
          break;
        default:
          this.batchAccountOperate(
            this.batchOperateValue,
            this.multipleSelectedAcc
          );
      }
    },
    // 表格多选控制
    handleSelectionChange(val) {
      ...
      val.length === this.accountTableData.length
