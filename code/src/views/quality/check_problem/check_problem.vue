  ...
  <el-container>
    ...
    <el-main>
      <el-tabs v-model="showTabName" @tab-click="changTabShow">
        ...
        <el-tab-pane label="待指派" name="second">
          <tabProblems />
        </el-tab-pane>
        <el-tab-pane label="待整改" name="third">
          <tabProblems />
        </el-tab-pane>
        <el-tab-pane label="待销项" name="fourth">
          <tabProblems />
        </el-tab-pane>
        <el-tab-pane label="已销项" name="fiveth">
          <tabProblems />
        </el-tab-pane>
        <el-tab-pane label="已作废" name="sixth">
          <tabProblems />
        </el-tab-pane>
      </el-tabs>
    </el-main>
...
<script>
import TabProblems from '@/views/quality/check_problem/components/tabProblems'
import ProblemDetail from '@/views/quality/check_problem/components/problemDetail'
export default {
