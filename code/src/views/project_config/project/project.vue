            ...
            <template slot-scope="scope">
              ...
              <template v-else-if="scope.row.type === 1">
                ...
                <el-dropdown size="small" @command="(order)=>projectOperaHandle(order, scope.row)">
                  <el-button size="mini" class="no-border">更多操作</el-button>
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="addSection" :disabled="!(pagePermission.add)">新增标段</el-dropdown-item>
                    <el-dropdown-item command="delete" :disabled="!(pagePermission.delete)">删除</el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </template>
              <template v-else-if="scope.row.type === 2">
                ...
                <el-dropdown size="small" @command="(order)=>projectOperaHandle(order, scope.row)">
                  <el-button size="mini" class="no-border">更多操作</el-button>
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item command="setContract" :disabled="!(pagePermission.update)">分包设置</el-dropdown-item>
                    <el-dropdown-item command="delete" :disabled="!(pagePermission.delete)">删除</el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </template>
