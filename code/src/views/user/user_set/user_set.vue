<template>
  <el-container class="container global-container">
    <el-main v-loading="isLoading">
      <el-form ref="userInfoForm" :model="userInfoForm" :rules="userInfoFormRules">
        ...
        <el-form-item label="生日" prop="birthday">
          <el-date-picker v-model="userInfoForm.birthday" type="date" placeholder="选择日期"/>
        </el-form-item>
    ...
    />
    <changePhoneNum v-show="isChangePhoneShow" :is-change-phone-show.sync="isChangePhoneShow"/>
  </el-container>
</template>
<script>
  ...
  data() {
    return {
      ...
      userInfoFormRules: {
        ...
        email: [{ required: true, trigger: "change", validator: isvalidEmail }],
